  ...
  return (
    <div className="hero-section">
      <div className="hero-text">
        ...
        <p>
          Get accurate book recommendations based on your most recent book. Just
          enter your the title of either your recent read or favorite book on
          the search bar, search and you're ready to go!
        </p>
